...
export class GameView extends React.Component<IGameViewProps, {}> {
  ...
  public render() {
    return (
      <div className="game">
        <span className="playername">Player Name: {this.props.game.playername}</span><br />
        <span className="answers">Answers: {this.props.game.answers.join(" ")}</span><br />
        <span className="mistakes">Number of mistakes: {this.props.game.mistakes}</span><br />
        <label>
          Enter a letter:
